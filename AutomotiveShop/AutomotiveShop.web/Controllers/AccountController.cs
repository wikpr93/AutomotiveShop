...
using AutomotiveShop.service.ViewModels.Users;
...
namespace AutomotiveShop.web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            if (!UserManager.IsInRole(userId, "Administrator") || roleName == "Administrator")
            {
        ...
        public ActionResult AddToRole(string userId, string roleName)
        {
            ...
            {
                result = UserManager.AddToRole(userId, "Moderator");
            }
            return RedirectToAction("Index", "Users");
        }
    }
